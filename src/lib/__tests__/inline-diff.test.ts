...
describe("computeHunkInlineChanges", () => {
    ...
    it("pairs lines by index", () => {
        const result = computeHunkInlineChanges(["const a = 1;"], ["const a = 2;"]);
    ...
    it("marks unpaired added lines as fully changed", () => {
        const result = computeHunkInlineChanges(["old"], ["new1", "new2", "new3"]);
    ...
    it("marks unpaired removed lines as fully changed", () => {
        const result = computeHunkInlineChanges(["old1", "old2", "old3"], ["new"]);

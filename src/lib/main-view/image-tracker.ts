...
export class ImageTracker {
    ...
    private _queues: Map<number, { filePath: string; base64: string; mimeType: string }[]> =
        new Map();
    ...
    shiftPending(
        ptyId: number,
    ): { filePath: string; base64: string; mimeType: string } | undefined {
